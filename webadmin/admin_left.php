			  ...
			  <TR>
				<TD class=menu_title id=menuTitle1
				  ...
				  background=images/menu_bgs.gif
					height=30>
						<div align="center"><SPAN><a href="admin_right.php" target="main" >后台首页</a></SPAN> </div>
				</TD>
			  </TR>
			</TBODY>
	    </TABLE>
				...
				<DIV class=sec_menu style="WIDTH: 182px">
					<TABLE cellSpacing=0 cellPadding=0 width=182 align=center>
						<TBODY>
						  ...
						  <TR>
							<TD  class="MM" ><div align="center"><A href="web_settings.php" target=main>网站信息设置</A></div></TD>
						  </TR>
						 <TR><TD class="MM"  ><div align="center"><A
  ...
  <tbody>
    <tr>
      <td class="menu_title" id="menuTitle1"
          ...
          onmouseout="this.className='menu_title';"
          background="images/menu_bgs.gif"
            height="30"><div align="center"><span>云文件管理</span> </div></td>
    </tr>
    <tr>
        ...
        <table cellspacing="0" cellpadding="0" width="182" align="center">
          ...
          <tr>
            <td  class="MM" ><div align="center"><a
                  href="cloud_user_list.php"
                  target="main">用户列表</a></div></td>
          </tr>
          <tr>
            <td  class="MM" ><div align="center"><a
                  href="cloud_audio_list.php"
                  target="main">录音列表</a></div></td>
          </tr>
          <tr>
            <td  class="MM" ><div align="center"><a
                  href="cloud_video_list.php"
                  target="main">录像列表</a></div></td>
          </tr>
		  <tr>
            <td  class="MM" ><div align="center"><a
                  href="cloud_image_list.php"
                  target="main">图片列表</a></div></td>
          </tr>
          <tbody>
          </tbody>
        </table>
   ...
   <TBODY>
     <TR>
       <TD class=menu_title id=menuTitle1
          ...
          onmouseout="this.className='menu_title';"
          background=images/menu_bgs.gif
            height=30><div align="center"><SPAN>分类管理</SPAN> </div></TD>
     </TR>
     <TR>
           ...
           <TABLE cellSpacing=0 cellPadding=0 width=182 align=center>
             <TBODY>
               ...
               <TR>
                  ...
                  target=main>添加一级分类</A></div></TD>
               </TR>
               <TR>
                  <TD  class="MM" > <div align="center"><A
                  href="category_list.asp"
                  target=main>分类列表</A></div></TD>
               </TR>
             <TBODY>
             </TBODY>
           </TABLE>
...
<TABLE cellSpacing=0 cellPadding=0 width=182 align=center>
              ...
              <TD id=submenu21 style="DISPLAY: none"><DIV class=sec_menu style="WIDTH: 182px">
                  <TABLE cellSpacing=0 cellPadding=0 width=182 align=center>
                    <TBODY>
                      ...
                      <TR>
                         <TD  class="MM" > <div align="center"><A href="ad_add.asp"  target=main>添加图片</A></div></TD>
                      </TR>	
                      <TR>
                         <TD  class="MM" > <div align="center"><A href="ad_MutiAdd.asp"  target=main>批量上传图片</A></div></TD>
                      </TR>						  				  					  
                      <TR>
 ...
 <TR>
        ...
        <TR>
          ...
          onmouseout="this.className='menu_title';"
          background=images/menu_bgs.gif
            height=30><div align="center"><SPAN>生成管理</SPAN> </div></TD>
                    </TR>
                    <TR>
                      <TD id=submenu33 style="DISPLAY: none"><DIV class=sec_menu style="WIDTH: 182px">
                          <TABLE cellSpacing=0 cellPadding=0 width=182 align=center>
                            <TBODY>
							  ...
							  <TR>
                                 <TD  class="MM" > <div align="center"><a href="html_items.asp" target="main">栏目生成</a></div></TD>
                              </TR>
							  <TR>
                                 <TD  class="MM" > <div align="center"><A href="html_article.asp"  target=main>内容生成</A></div></TD>
                              </TR>
                            <TBODY>
                            </TBODY>
                          </TABLE>
                            ...
                            <TBODY>
                              ...
                              <TR>
                                <TD height="40"  ><div align="center">
                                  <p><A href="http://www.drovik.com/"  target="_blank" title="Steersman">Steersman</A> 版权所有</p>
                                </div></TD>
                              </TR>
